...
const Signupforget = ({ navigation, route }) => {
    ...
    <View style={styles.login9RegisterMobile}>
      ...
      <View style={styles.frameView}>
        <View style={styles.groupView1}>
          <Text style={styles.signUpText}>{flag ? "Forget" : "Sign-up"} </Text>
        ...
        <View style={[styles.groupView5, styles.mt47]}>
          ...
          <Text style={flag ? styles.registerText : styles.registerText1 }>{flag ? "Forget-Pass" : "Sign-Up"}</Text>
        </View>
      </View>
      <View style={styles.rectangleView3} />
      <View style={styles.rectangleView4} />
      <TouchableOpacity
        style={flag ? styles.youCanLoginHere : styles.youCanLoginHere1 }
